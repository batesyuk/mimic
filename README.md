# Mimic, simple web service stubs for testing [![Build Status](https://travis-ci.org/nicholasjackson/mimic.svg?branch=master)](https://travis-ci.org/nicholasjackson/mimic)
